...
export function Terminal() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Market Stats Bar */}
      <div className="h-14 border-b border-border flex items-center px-4 gap-6 shrink-0 bg-background/50">
        <div className="flex items-center gap-2">
          <select 
            value={selectedMarket}
            onChange={(e) => setSelectedMarket(e.target.value)}
            className="bg-secondary text-foreground px-2 py-1 rounded font-bold text-lg outline-none cursor-pointer border-none"
          >
            {markets.map(m => (
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Chart Column */}
        <div className="flex-1 border-r border-border flex flex-col bg-card">
